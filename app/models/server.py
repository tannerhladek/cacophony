...
class Server(db.Model):
   ...
   server_image_url = db.Column(db.String(1000), nullable=False, default='https://cdn.discordapp.com/attachments/920424165415223356/926879518906548324/default_server_image.png')
